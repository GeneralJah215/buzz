...
import { ChannelFindBarSlot } from "@/features/search/ui/ChannelFindBar";
    ...
    >
      ...
      {!isSinglePanelView ? (
        ...
        >
          ...
          <ChannelFindBarSlot find={channelFind} />
          <MessageTimeline
            ...
            searchActiveMessageId={channelFind.mainTimelineActiveMatchId}
