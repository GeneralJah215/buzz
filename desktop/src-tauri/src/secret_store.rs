...
#[path = "secret_store_chunks.rs"]
mod chunks;
use chunks::{
    chunk_key, payload_digest, split_utf16, utf16_len, BlobReadError, ChunkHeader, Generation,
    MAX_ASSEMBLED_BYTES, MAX_CHUNKS, MAX_ENTRY_UTF16,
};
